...
public class ModelLWSK_Cadet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "lwsk_cadet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(96, 0).mirror()
						...
						.texOffs(114, 121).addBox(-3.0F, -7.0F, 4.0F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(99, 122).addBox(3.0F, -7.0F, 4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(99, 122).addBox(-5.0F, -7.0F, 4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(88, 121).addBox(-5.0F, -7.0F, 2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(88, 121).addBox(4.0F, -7.0F, 2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(88, 121).addBox(4.0F, -7.0F, 2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(69, 117).addBox(-5.0F, -7.0F, -5.0F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
						.texOffs(69, 117).addBox(4.0F, -7.0F, -5.0F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
						.texOffs(69, 117).addBox(4.0F, -7.0F, -5.0F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
						.texOffs(64, 116).addBox(-4.0F, -7.0F, -5.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(64, 116).addBox(3.0F, -7.0F, -5.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(63, 126).addBox(2.0F, -6.5F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(46, 126).addBox(-3.0F, -7.0F, -5.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(63, 126).addBox(-3.0F, -6.5F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(47, 117).addBox(-1.0F, -6.25F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition bone = leftArm.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 69)
						...
						.addBox(-1.5F, 1.0F, -7.0F, 0.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(10, 96)
						.addBox(-1.5F, 12.0F, -2.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(10, 95)
						...
						.addBox(-1.5F, 10.0F, -2.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(29, 80)
						.addBox(-1.5F, 5.0F, -3.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(12, 90)
						.addBox(-1.5F, 6.0F, -4.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(12, 93)
						.addBox(-1.5F, 9.0F, -4.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(12, 90)
						.addBox(-1.5F, 6.0F, -4.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(38, 69)
						...
						.addBox(-1.5F, 5.0F, -3.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 87)
						.addBox(-1.5F, 6.0F, -4.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(43, 82)
						.addBox(-1.5F, 14.0F, -4.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(9, 97)
						.addBox(-1.5F, 14.0F, -3.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
