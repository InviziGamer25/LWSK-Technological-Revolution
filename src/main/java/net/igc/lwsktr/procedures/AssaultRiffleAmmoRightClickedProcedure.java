...
public class AssaultRiffleAmmoRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getLevelData().getGameRules().getInt(LwskTrModGameRules.AMMORELOAD)) == 1) {
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(LwskTrModItems.ASSAULT_RIFLE_AMMO.get())) : false) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == LwskTrModItems.ASSAULT_RIFLENOAMMO.get()) {
					if (entity instanceof LivingEntity _entity)
						_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 65, 5));
					...
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(LwskTrModItems.ASSAULT_RIFLE_AMMO.get());
					...
					new Object() {
						...
						private void run() {
							if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == LwskTrModItems.ASSAULT_RIFLENOAMMO.get()) {
								...
								if (entity instanceof LivingEntity _entity) {
									ItemStack _setstack = new ItemStack(LwskTrModItems.ASSAULT_RIFLE.get());
			...
			if (!(entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(LwskTrModItems.ASSAULT_RIFLE_AMMO.get())) : false)) {
				if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(LwskTrModItems.EXPLOSIVE_ASSAULT_RIFLE_AMMO.get())) : false) {
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == LwskTrModItems.ASSAULT_RIFLENOAMMO.get()) {
						if (entity instanceof LivingEntity _entity)
							_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 55, 5));
						if (world instanceof Level _level)
							_level.getGameRules().getRule(LwskTrModGameRules.AMMORELOAD).set(2, _level.getServer());
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
						...
						if (entity instanceof Player _player) {
							ItemStack _stktoremove = new ItemStack(LwskTrModItems.EXPLOSIVE_ASSAULT_RIFLE_AMMO.get());
							_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
						}
						new Object() {
							private int ticks = 0;
							...
							private void run() {
								if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == LwskTrModItems.ASSAULT_RIFLENOAMMO.get()) {
									...
									if (entity instanceof LivingEntity _entity) {
										ItemStack _setstack = new ItemStack(LwskTrModItems.EXPLOSIVE_ASSAULT_RIFLE.get());
										_setstack.setCount(1);
										_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
										if (_entity instanceof Player _player)
											_player.getInventory().setChanged();
				...
				if (!((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(LwskTrModItems.ASSAULT_RIFLE_AMMO.get())) : false)
						|| (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(LwskTrModItems.EXPLOSIVE_ASSAULT_RIFLE_AMMO.get())) : false))) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
